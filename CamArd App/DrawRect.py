...
from PyQt5.QtWidgets import QGraphicsRectItem, QApplication, QGraphicsView, QGraphicsScene, QGraphicsItem,QDialog,QWidget,QPushButton,QGraphicsPixmapItem,QGraphicsObject
...
class GraphicsRectItem(QGraphicsRectItem):  # class QGraphicsRectItem for draw rectangle ingraphicsence
    ...
    def mouseMoveEvent(self, mouseEvent):
        ...
        print(scenebouding.left()+4,scenebouding.right()-4)
